  ...
  return (
    <div className="py-5 px-5 md:px-12 lg:px-28 border border-black">
      ...
      <div className="text-center my-8 ">
        ...
        <form onSubmit={onSubmitHandler} className=' border border-black flex justify-between max-w-[500px] scale-75 sm:scale-100 mx-auto mt-10 shadow-[-7px_7px_0px_#000000]' action="">
